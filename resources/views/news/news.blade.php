...
<div class="banner-carousel banner-carousel-2 mb-0">
    <div class="banner-carousel banner-carousel-2 mb-0">
        <div id="banner-area" class="banner-area" style="background-image:url(images/news2.JPG)">
        ...
        <div class="col-lg-8 mb-5 mb-lg-0">
            ...
            <div class="post-body">
              <div class="entry-header">
                <div class="post-meta">
                  ...
                  <span class="post-meta-date"><i class="far fa-calendar"></i> June 14, 2022</span>
                  <span class="post-comment"><i class="far fa-comment"></i> 03<a href="#"
                      class="comments-link">Comments</a></span>
                </div>
                <h2 class="entry-title">
                 We Just completed commercial Landscape
                                    work
                </h2>
              </div><!-- header end -->
          ...
          <div class="author-box d-nlock d-sm-flex">
            <div class="author-img mb-4 mb-md-0">
              <img loading="lazy" src="images/news/" alt="author">
            </div>
            <div class="author-info">
              <h3>Godfrey Godson<span>Site Engineer</span></h3>
            ...
            <ul class="comments-list">
              <li>
                <div class="comment d-flex">
                  <img loading="lazy" class="comment-avatar" alt="author" src="images/news/">
                  <div class="comment-body">
                    <div class="meta-data">
                      <span class="comment-author mr-3">Emmanuel Lema</span>
                      <span class="comment-date float-right">January 17, 2022 at 1:38 pm</span>
                    </div>
